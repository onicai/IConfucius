...
# scripts/stop-timers.sh --network [local|testing|development|prd]
#######################################################################
...
echo "==========================================="
cd src/IConfucius
echo "Stopping timer for IConfucius:"
dfx canister call iconfucius_ctrlb_canister stopTimerExecutionAdmin --network $NETWORK_TYPE